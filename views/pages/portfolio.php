...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="templates/css/portfolioStyle.css"/>
    ...
    <section id="homeContent">
        ...
        <article class="art">
            ...
            <div class="textArticleHome">
                ...
                <p id="imgs_projets"><a href="https://valerian-dufrene.000webhostapp.com/" target="_blank"><img src="assets/img/projet1_mini.png" alt="projet1_mini" name="projet1_mini"/></a></p>
            </div>
        </article>
        <article class="art">
            ...
            <div class="textArticleHome">
                ...
                <p id="imgs_projets"><a href="http://dev-openstrasbourg.pantheonsite.io/" target="_blank"><img src="assets/img/projet2_mini.png" alt="projet2_mini" name="projet2_mini"/></a></p>
            </div>
        </article>
        <article class="art">
            ...
            <div class="textArticleHome">
                ...
                <p id="imgs_projets"><a href="https://velo-v-valros.000webhostapp.com/" target="_blank"><img src="assets/img/projet3_mini.png" alt="projet3_mini" name="projet3_mini"/></a></p>
            </div>
        </article>
        <article class="art">
            ...
            <div class="textArticleHome">
                ...
                <p id="imgs_projets"><a href="" target="" onclick="javascript:alert('Le projet n\'est pas encore présenté. Il sera accessible une fois validé.')"><img src="assets/img/projet4_mini.png" alt="projet4_mini" name="projet4_mini"/></a></p>
            </div>
        </article>
        ...
        <article class="art">
            ...
            <div class="textArticleHome">
                ...
                <p id="imgs_projets"><a href="?action=shifumi" target="_blank"><img src="assets/img/shifumi01.png" alt="Shifumi01" name=""/></a></p>
            </div>
        </article>
        <article class="art">
            <h3></h3>
            <div class="textArticleHome">
                <p id="imgs_projets"><a href="bonus/" target="_blank" ><img src="assets/img/" alt="imgProjet*" name=""/></a></p>
            </div>
        </article>
    </section>
